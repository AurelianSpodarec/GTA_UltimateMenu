...
function trollingMenu_kamikadzePlane(parent)
    local_trollingMenu_kamikadzePlane = menu.add_feature("Plane", "parent", parent, nil).id
    ...
    --     --     system.wait(100)
    --     -- end  
    --     local Plane = HP_Spawn.Vehicle(-1214505995, player.get_player_coords(player.player_id()) + v3(math.random(-200, 200), math.random(-400, 400), math.random(70, 94)), math.random(0, 0))
    --     local Pilot = HP_Spawn.Ped(-413447396)
