    ...
    menu.add_feature("Spawn Rubios Attack Chopper", "action", parent, function(feat, pid)
        ...
        -- Send SMS to player as it spawns (Mr Rubio is not happy!)
            ...
            for i = 1, 1 do
                ...
                local Heli = ULT_Spawn.Vehicle(0xA09E15FD, player.get_player_coords(player.player_id()) + v3(math.random(-200, 200), math.random(-200, 200), math.random(50, 60)), math.random(0, 0))
...
-- ULT_PedCombat(attribute, ability)