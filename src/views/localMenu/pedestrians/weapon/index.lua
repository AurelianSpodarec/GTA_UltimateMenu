...
function pedestriansMenu_weapon(parent)
    ...
    pedestriansMenu_giveAllweapon = menu.add_feature('Give weapons to all', 'action', pedestriansMenu_weapon, function() pedModel.setAllWeapon() end).id
    ...
    pedestriansMenu_removeAllWeapon = menu.add_feature('Remove weapons from all', 'action', pedestriansMenu_weapon, function() pedModel.removeAllWeapon() end).id
